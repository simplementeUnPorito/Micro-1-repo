// ======================================================================
// PuertaConClave.v generated from TopDesign.cysch
// 10/23/2024 at 22:33
...
module top ;
    ...
    Timer_v2_80_0 timer_debouncer (
        ...
        .tc(Net_170),
        .trigger(1'b1));
    defparam timer_debouncer.CaptureCount = 2;
    defparam timer_debouncer.CaptureCounterEnabled = 0;
    defparam timer_debouncer.DeviceFamily = "PSoC5";
    defparam timer_debouncer.InterruptOnCapture = 0;
    defparam timer_debouncer.InterruptOnTC = 0;
    defparam timer_debouncer.Resolution = 8;
    defparam timer_debouncer.SiliconRevision = "0";
	...
	wire [2:0] tmpOE__Led_net;
	wire [2:0] tmpIO_2__Led_net;
	wire [0:0] tmpINTERRUPT_0__Led_net;
	electrical [0:0] tmpSIOVREF__Led_net;

	cy_psoc3_pins_v1_10
		#(.id("14edb44b-39d2-461b-ae9b-332a03a2a23b"),
		...
		Led
		 (.oe(tmpOE__Led_net),
		  .y({3'b0}),
		  .fb({Net_178, Net_183, Net_180}),
		  .io({tmpIO_2__Led_net[2:0]}),
	...
	assign tmpOE__Led_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};


    assign Net_181 = ~Net_180;

    Timer_v2_80_2 timer_puertaAbierta (
        .capture(1'b0),
        .capture_out(Net_149),
        .clock(Net_46),
        .enable(Net_180),
        ...
        .tc(Net_122),
        .trigger(1'b1));
    defparam timer_puertaAbierta.CaptureCount = 2;
    defparam timer_puertaAbierta.CaptureCounterEnabled = 0;
    defparam timer_puertaAbierta.DeviceFamily = "PSoC5";
    defparam timer_puertaAbierta.InterruptOnCapture = 0;
    defparam timer_puertaAbierta.InterruptOnTC = 0;
    defparam timer_puertaAbierta.Resolution = 16;
    defparam timer_puertaAbierta.SiliconRevision = "0";
	...
	cy_clock_v1_0
		#(.id("1d7b2408-6b0f-4531-8d9d-7e8a652e5993"),
		  .source_clock_id("315365C3-2E3E-4f04-84A2-BB564A173261"),
		  .divisor(10),
		  .period("0"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__SensorPuerta_net;
	wire [0:0] tmpIO_0__SensorPuerta_net;
	wire [0:0] tmpINTERRUPT_0__SensorPuerta_net;
	electrical [0:0] tmpSIOVREF__SensorPuerta_net;

	cy_psoc3_pins_v1_10
		#(.id("964edf65-ceff-45f4-8a8b-ac933716559d"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SensorPuerta
		 (.oe(tmpOE__SensorPuerta_net),
		  .y({1'b0}),
		  .fb({Net_190}),
		  .io({tmpIO_0__SensorPuerta_net[0:0]}),
		  .siovref(tmpSIOVREF__SensorPuerta_net),
		  .interrupt({tmpINTERRUPT_0__SensorPuerta_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SensorPuerta_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
