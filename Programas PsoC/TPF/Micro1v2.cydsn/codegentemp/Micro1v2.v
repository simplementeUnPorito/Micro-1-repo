// ======================================================================
// Micro1v2.v generated from TopDesign.cysch
// 10/14/2024 at 18:00
...
module ADC_SAR_v3_10_4 (
	...
	cy_clock_v1_0
		#(.id("3d036f97-5787-443b-b383-124d2c4f9979/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [4:0] tmpOE__keyboard_out_net;
	wire [4:0] tmpFB_4__keyboard_out_net;
	wire [4:0] tmpIO_4__keyboard_out_net;
	wire [0:0] tmpINTERRUPT_0__keyboard_out_net;
	electrical [0:0] tmpSIOVREF__keyboard_out_net;
	...
	cy_psoc3_pins_v1_10
		...
		keyboard_out
		 (.oe(tmpOE__keyboard_out_net),
		  .y({5'b0}),
		  .fb({tmpFB_4__keyboard_out_net[4:0]}),
		  .io({tmpIO_4__keyboard_out_net[4:0]}),
		  .siovref(tmpSIOVREF__keyboard_out_net),
		  .interrupt({tmpINTERRUPT_0__keyboard_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__keyboard_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{5'b11111} : {5'b11111};

	wire [3:0] tmpOE__keyboard_in_net;
	wire [3:0] tmpFB_3__keyboard_in_net;
	wire [3:0] tmpIO_3__keyboard_in_net;
	wire [0:0] tmpINTERRUPT_0__keyboard_in_net;
	electrical [0:0] tmpSIOVREF__keyboard_in_net;
	...
	cy_psoc3_pins_v1_10
		...
		keyboard_in
		 (.oe(tmpOE__keyboard_in_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__keyboard_in_net[3:0]}),
		  .io({tmpIO_3__keyboard_in_net[3:0]}),
		  .siovref(tmpSIOVREF__keyboard_in_net),
		  .interrupt({tmpINTERRUPT_0__keyboard_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__keyboard_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
	...
	cy_clock_v1_0
		#(.id("b1dc96f6-6fee-4bff-96d8-3e96fa159254"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("5000000000"),
		  .is_direct(0),
	...
	wire [3:0] tmpOE__Servo_net;
	wire [3:0] tmpFB_3__Servo_net;
	wire [3:0] tmpIO_3__Servo_net;
	wire [0:0] tmpINTERRUPT_0__Servo_net;
	electrical [0:0] tmpSIOVREF__Servo_net;

	cy_psoc3_pins_v1_10
		#(.id("7ea2200b-f5e5-4b97-98f5-566471f4320d"),
		...
		Servo
		 (.oe(tmpOE__Servo_net),
		  .y({Net_463, Net_462, Net_452, Net_451}),
		  .fb({tmpFB_3__Servo_net[3:0]}),
		  .io({tmpIO_3__Servo_net[3:0]}),
	...
	assign tmpOE__Servo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
